 ...
 */
        ...
        /* this.canvass.addEventListener("mouseover", this.triggerWave);
        this.canvass.addEventListener("mousedown", this.triggerWave); */

        this.canvass.addEventListener("mouseover", (e) => this.triggerWave(e));
        this.canvass.addEventListener("mousedown", (e) => this.triggerWave(e));

        window.addEventListener('scroll', (e) => this.triggerWave(e));
    }
/* 
    onMouseEvent(e) {
        //if (this.mouseoverSuspended) return; 
        this.triggerWave(e);
    }
    
    onScroll(e) {
        this.mouseoverSuspended = true;
    
        this.triggerWave(e); 
    
        // Réactive mouseover après 200ms (à ajuster si besoin)
        setTimeout(() => {
            this.mouseoverSuspended = false;
        }, 200);
    } */
